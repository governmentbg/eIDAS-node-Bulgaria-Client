package bg.is.eidas.client;

import bg.is.eidas.client.config.EidasClientProperties;
import bg.is.eidas.client.exception.AuthenticationFailedException;
import bg.is.eidas.client.exception.EidasClientException;
import bg.is.eidas.client.exception.InvalidRequestException;
import bg.is.eidas.client.response.AssertionValidator;
import bg.is.eidas.client.response.AuthenticationResult;
import bg.is.eidas.client.session.RequestSession;
import bg.is.eidas.client.session.RequestSessionService;
import bg.is.eidas.client.util.OpenSAMLUtils;
import bg.is.eidas.client.config.EidasCredentialsConfiguration.FailedCredentialEvent;
import bg.is.eidas.client.config.OpenSAMLConfiguration;
