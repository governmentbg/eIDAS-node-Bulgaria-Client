package bg.is.eidas.client.config;

import bg.is.eidas.client.session.HazelcastRequestSessionServiceImpl;
...
public class HazelcastConfiguration {
    ...
    private Map<String, MapConfig> buildHazelcastMapConfigurations() {
        ...
        mapConfigs.put(HazelcastRequestSessionServiceImpl.UNANSWERED_REQUESTS_MAP, mapConfig);
        return mapConfigs;
    }
    ...
    private MapConfig createMapConfig() {
        ...
        return (new MapConfig()).setName(HazelcastRequestSessionServiceImpl.UNANSWERED_REQUESTS_MAP)
